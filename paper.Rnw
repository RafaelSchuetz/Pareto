...
@
>>>>>>> e374c897fa430f39f38663dd2617ee94ca47e4bb
...
Table \ref{GrantsRegressionsLunch}
...
texreg(list(lm_ts, lm_ts_o,lm_ts_i), caption = "Regression Results: Number of trips", custom.model.names = c("OLS", "OLS without Outliers", "OLS Impute"), scalebox = 0.8, label = 'GrantsRegressionsTrips')
