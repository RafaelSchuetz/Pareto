...
#  
texreg(list(mealsNo_sub.lm, tripsNo_sub.lm), label = "mealsTripsSubsidyRegressions")
@
...
<<DaytodayskillsSelfworth, echo=FALSE>>=
figureDaytodayskillsSelfworth = readRDS("./ANALYSIS/GRAPHS/PAPER/plot_dayToDaySkills_selfworth.Rds")
print(figureDaytodayskillsSelfworth)
@
...
\end{figure}
>>>>>>> d8da3cacee701be2a3ba97aa24572fdd6dff6c9e
...
<<FundamentalDynamicsTest, echo=FALSE, results='asis', message=FALSE, warning=FALSE>>=
# 
# # first, read in all Rds objects that you need
# 
...
fundamental_dynamics <- stargazer(fundamental_dynamics,
                                  summary = FALSE,
                               # digits = c(0, 0, 1, 1, 0, 0),
          caption = "Summary Statistics",
          # align = "lmmmmm", 
...
% \end{center}
% \end{table}
>>>>>>> f611aad9f59cfe26b55bd40fd6b8a9484e9f10b8
