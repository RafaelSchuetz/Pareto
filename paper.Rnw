...
<<GrantsRegressions Lunch, echo=FALSE, results='asis', message=FALSE>>=
...
texreg(list(lm_ms, lm_ms_o,lm_ms_i), caption = "Effects of subsidy for Meals program on number of meals", custom.model.names = c("OLS", "OLS without Outliers", "OLS Impute"), scalebox = 0.8)
@

<<GrantsRegressions Trips, echo=FALSE, results='asis', message=FALSE>>=
...
texreg(list(lm_ts, lm_ts_o,lm_ts_i), caption = "Effects of subsidy for Trips program on number of trips", custom.model.names = c("OLS", "OLS without Outliers", "OLS Impute"), scalebox = 0.8)
...
<<HealthRegressions_LessIll, echo=FALSE, results='asis', message=FALSE>>=
...
texreg(list(lDGE, lDGEw, lDGE_i, lDGE_iw), caption = "Regression Results: Less Ill", custom.model.names = c("OLS", "WLS", "OLS Impute","WLS Impute"), scalebox = 0.8)
@

<<HealthRegressions_DietaryKnowledge, echo=FALSE, results='asis', message=FALSE>>=
...
texreg(list(dDGE, dDGEw, dDGE_i, dDGE_iw), caption = "Regression Results: Dietary Knowledge", custom.model.names = c("OLS", "WLS", "OLS Impute","WLS Impute"), scalebox = 0.8)
@

<<HealthRegressions_AppreciateHealthy, echo=FALSE, results='asis', message=FALSE>>=
...
texreg(list(aDGE, aDGEw, aDGE_i, aDGE_iw), caption = "Regression Results: Appreciate Healthy", custom.model.names = c("OLS", "WLS", "OLS Impute","WLS Impute"), scalebox = 0.8)
@
...
texreg(list(ss, tss, ssI, tssI ), caption = "Regression Results: Selfworth", custom.model.names = c("OLS Lunch", "OLS Trips", "OLS Lunch Impute", "OLS Trips Impute" ), scalebox = 0.8)
@
...
texreg(list(ds, tds, dsI, tdsI ), caption = "Regression Results: dayToDaySkills", custom.model.names = c("OLS Lunch", "OLS Trips", "OLS Lunch Impute", "OLS Trips Impute" ), scalebox = 0.8)
@
