...
{\\vspace{2pt} Dependent variable is less ill \\\\ Model (1): original data set, simple linear model with controls, estimated with OLS \\\\ Model (2): original data set, simple linear model with controls, estimated with WLS \\\\ Model (3): imputed data set, simple linear model, estimated with OLS \\\\ Model (4): imputed data set, simple linear model, estimated with WLS \\\\ All regressions are estimated with robust standard errors %stars.}", scalebox = 0.8, label = 'expandLessIll')
@
...
stargazer(lessIllOdds@coef3, title= "Propodss Regression Results: Less Ill", align = TRUE, label = "lessIllOdds")
...
stargazer(dietaryOdds@coef3, title= "Propodss Regression Results: Dietary Knowledge", align = TRUE, label = "dietaryOdds")
@
...
stargazer(appreciateOdds@coef3, title= "Propodss Regression Results: Appreciate Healthy", align = TRUE, label = "appreciateOdds")
@
...
stargazer(selfworthOdds@coef3, title= "Propodss Regression Results: Selfworth", align = TRUE, label = "selfworthOdds")
@
...
stargazer(dayToDayOdds@coef3, title= "Propodss Regression Results: Everyday expertise", align = TRUE, label = "dayToDayOdds")
@
