...
@
The first two columns are simple OLS models, in column 3 and 4 outliers are excluded and in column 5 and 6 data is imputed. 
(DESCRIBE RESULTS) (COMPARE TO SUMMARY STATISTICS)
...
tss = readRDS("./ANALYSIS/Tables/selfworthTrips_scaled.Rds")
tds = readRDS("./ANALYSIS/Tables/dayToDaySkillsTrips_scaled.lm.Rds")

texreg(list(lm_s, lm_d, ts, td, lm_ss, lm_ds, tss, tds), caption = "Equal Opportunities Regressions", custom.model.names = c("selfworth", "dayToDaySkills", "selfworth", "dayToDaySkills", "selfworth", "dayToDaySkills", "selfworth", "dayToDaySkills" ))
@

<<ChanceEqualityRegressionsImpute, echo=FALSE, results='asis', message=FALSE>>=
...
dsI = readRDS("./ANALYSIS/Tables/dayToDaySkills_IM_scaled.lm.Rds") #standardized 
...
texreg(list(sI, dI, tsI, tdI, ssI, dsI, tssI, tdsI), caption = "Equal Opportunities Regressions, imputed data", custom.model.names = c("selfworth", "dayToDaySkills", "selfworth", "dayToDaySkills", "selfworth", "dayToDaySkills", "selfworth", "dayToDaySkills" ))
@
