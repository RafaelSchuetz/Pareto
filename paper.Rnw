...
texreg(list(lm_ms, lm_ts), caption = "Grants Regressions", custom.model.names = c("Number of Meals", "Number of Trips"))
@
...
=======
<<HealthRegressionsTimePlots, echo=FALSE, message=FALSE>>=
Health_timeplots <- readRDS("./ANALYSIS/GRAPHS/PAPER/Health_Year.Rds")
print(Health_timeplots)
@
