...
\rmfamily
\title[Cleansing/Sullying Effects of Recessions]{Analyse der Survey-Daten von CHILDREN for a better World e.V. \\
	\small{\textit{following Kehrig: The Cyclical Nature of the Productivity Distribution}}}
\author[Laura, Laura, Jonathan, Rafael und Yannick]{Laura Huber, Laura Jepsen, Jonathan Kirschner, Rafael Schütz, Yannick Zurl}
\date{March 3, 2020}
