...
\\Number of Meals and Number of Trips
...
{\ttfamily\noindent\color{warningcolor}{\#\# Warning in gzfile(file, "{}rb"{}): kann komprimierte Datei './ANALYSIS/Tables/selfworthTrips\_scaled.lm.Rds' nicht öffnen. Grund evtl. 'No such file or directory'}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in gzfile(file, "{}rb"{}): kann Verbindung nicht öffnen}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in "{}list"{} \%in\% class(l)[1]: Objekt 'tss' nicht gefunden}}\end{kframe}

\begin{kframe}


{\ttfamily\noindent\color{warningcolor}{\#\# Warning in gzfile(file, "{}rb"{}): kann komprimierte Datei './ANALYSIS/Tables/selfworth\_IM\_scaled.Rds' nicht öffnen. Grund evtl. 'No such file or directory'}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in gzfile(file, "{}rb"{}): kann Verbindung nicht öffnen}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in "{}list"{} \%in\% class(l)[1]: Objekt 'ssI' nicht gefunden}}\end{kframe}
...
% Date and time: Mi, Feb 26, 2020 - 13:07:50
