...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: \$ operator not defined for this S4 class}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in print(Health\_plots): Objekt 'Health\_plots' nicht gefunden}}\end{kframe}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in print(Health\_percentageplots): Objekt 'Health\_percentageplots' nicht gefunden}}\end{kframe}


% Table created by stargazer v.5.2.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: Di, Feb 25, 2020 - 15:52:15
...
% Table created by stargazer v.5.2.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: Di, Feb 25, 2020 - 15:52:16
