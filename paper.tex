...
% Date and time: Di, Feb 25, 2020 - 12:22:23
% Requires LaTeX packages: dcolumn 
\begin{table}[!htbp] \centering 
  \caption{Regression outcome: Grants} 
  \label{} 
...
\hline \\[-1.8ex] 
 realSubsidy & 2.605^{***} &  \\ 
  & (0.555) &  \\ 
  & & \\ 
 realTripsSubsidy &  & 0.0002^{**} \\ 
  &  & (0.0001) \\ 
  & & \\ 
 Constant & -12,089.140^{**} & 3.705^{***} \\ 
  & (5,020.863) & (0.317) \\ 
  & & \\ 
\hline \\[-1.8ex] 
\hline 
...
% Table created by stargazer v.5.2.2 by Marek Hlavac, Harvard University. E-mail: hlavac at fas.harvard.edu
% Date and time: Di, Feb 25, 2020 - 12:22:24
