...
\item Variablen \glqq erweitertes Ernährungswissen\grqq und \grqq Wertschätzung gesunder Ernährung\glqq: kein Zusammenhang mehr erkennbar
\end{itemize}
\end{itemize}
\end{frame}
