...
# Standardfehler berechnet. Die Regression wird unter "lmdid" gespeichert
...
# Identifizieren aller Einrichtungen, bei denen das Treatment-Status von TreatEF = 1 auf TreatEF = 0 wechselt
...
### WICHTIG: Jetzt immer Datensatz dfcEF2 verwenden mit den modifizierten Treatment-Dummy 
...
# Regressionstables als RDS speichern
saveRDS(lmdid_dayToDaySkills, file = "./ANALYSIS/Tables/lmdid3_dayToDaySkills.Rds")
