...
data2013 <- data2013 %>% 
    dplyr::rename(id = 'Einrichtungsnummer', 
                      numberOfMeals = 'MT_Mahlzeiten 2013',
                      regularEaters = 'MT_Kinder 2013',
                      finalCosts = 'MT_Gesamtkosten 2013',
                      subsidy = 'Fördersumme final MT 2013',
                      ...
                      tripsSubsidy = 'Fördersumme EF 2013', 
...
data2014 <- data2014 %>% 
  dplyr::rename(id = 'Einrichtungsnummer',
                kidsPerMeal = 'Anzahl Kinder pro Mahlzeit 2014',
                numberOfMeals = 'MT_Mahlzeiten 2014', 
                frequency = 'Häufigkeit 2014(pro Woche x Wochen pro Jahr)', 
                totalCosts = 'MT_Gesamtkosten 2014', 
                subsidy = 'MT 2014', 
                DGE = 'DGE Kritierien', 
                ...
                tripsNo = 'Anzahl Entdeckeraktivitäten 2014', 
                tripsKidsNo = 'Anzahl Kinder 2014', 
                tripsSubsidy = 'EF 2014', 
                tripsDecisions = 'entschieden', 
                tripsOrganization = 'organisiert', 
                tripsReview = 'nachbereitet',
                tripsReached = 'erreicht',
