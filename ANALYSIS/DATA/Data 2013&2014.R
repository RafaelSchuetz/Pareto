...
data2013 <- data2013 %>% 
    dplyr::rename(id = 'Einrichtungsnummer', 
                      mealsNo = 'MT_Mahlzeiten 2014',
                      eatersPerMealNo = 'MT_Kinder 2014',
                      totalCost = 'MT_Gesamtkosten 2014',
...
data2014 <- data2014 %>% 
  dplyr::rename(id = 'Einrichtungsnummer',
                eatersPerMealNo = 'Anzahl Kinder pro Mahlzeit 2015',
                mealsNo = 'MT_Mahlzeiten 2015', 
                daysOfferedNo = 'Häufigkeit 2015(pro Woche x Wochen pro Jahr)', 
                totalCost = 'MT_Gesamtkosten 2015', 
                subsidy = 'MT 2015', 
                DGECriteriaNo = 'DGE Kritierien', 
                ...
                organicFoodstuff = 'Bio/ öko', 
                seasonalFoodstuff = 'Saisonal',  
