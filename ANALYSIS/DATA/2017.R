...
df_2017 <- df_2017 %>% 
  dplyr::rename(
    ...
    kidsPerMealNo = 'Anzahl Ki pro Mahlzeit 2018',
    newkidsNo = 'neue Ki 2018',
    cateringNo = 'Anzahl Catering 2018',
    mealInInstitutionNo = 'Anzahl idEg 2018',
    breakfastNo = 'Anzahl Frü 2018',
    lunchNo = 'Anzahl MT 2018',
    snackNo = 'Anzahl Nachmi 2018',
    dinnerNo = 'Anzahl AbBr 2018',
