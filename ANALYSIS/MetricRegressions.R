...
summary(lm(weeklyCooks_scaled ~ realSubsidyPerBeneficiary, mergedData))
summary(lm(monthlyCooks_scaled ~ realSubsidyPerBeneficiary, mergedData))
summary(lm(shoppers_scaled ~ realSubsidyPerBeneficiary, mergedData))
summary(lm(ownIdeas_scaled ~ realSubsidyPerBeneficiary, mergedData))
summary(lm(stayLonger_scaled ~ realSubsidyPerBeneficiary, mergedData))
summary(lm(easyDishes_scaled ~ realSubsidyPerBeneficiary, mergedData))
summary(lm(foodCulture_scaled ~ realSubsidyPerBeneficiary, mergedData))
summary(lm(influenceHome_scaled ~ realSubsidyPerBeneficiary, mergedData))
summary(lm(cookAtHome_scaled ~ realSubsidyPerBeneficiary, mergedData))
summary(lm(askRecipes_scaled ~ realSubsidyPerBeneficiary, mergedData))
summary(lm(moreConcentrated_scaled ~ realSubsidyPerBeneficiary, mergedData))
summary(lm(moreBalanced_scaled ~ realSubsidyPerBeneficiary, mergedData))
summary(lm(moreIndependent_scaled ~ realSubsidyPerBeneficiary, mergedData))
