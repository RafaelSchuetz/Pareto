...
all_yearPlots = map(response,
                ~map("year", plotOutcomeOverTime, y = .x) )
...
summaryStatistics_HealthVariables <- 
  plot_grid(lessIll_Time, AppreciateHealthy_Time, DietaryKnowledge_Time
                                       #         , 
